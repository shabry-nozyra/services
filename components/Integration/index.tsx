        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* <!-- Section Title Start --> */}
            ...
            headerInfo={{
              ...
              description: `Seamlessly manage your data remotely using Microsoft products like Teams, Office365, SharePoint, and more—anytime, anywhere.`,
            }}
            />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-office-365-240.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-sharepoint-240.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-azure-480.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-teams-240.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-outlook-240.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/icons8-linkedin-480.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
